...
class inquiry extends Controller{
    ...
    public function thankYou(){
        ...
        $leadId = $sfdc->createLead($_POST['first_name'], $_POST['last_name'], $_POST['email'], $_POST['phone'], $_POST['company'], $_POST['city'], $_POST['state'], $_POST['description'], 'a0l46000002BMaQAAW');
